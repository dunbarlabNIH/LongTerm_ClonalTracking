...
BCLH(data = zh19alldata[,as.vector(zh19indexmatrixnoNA)], names = zh19allnames[as.vector(zh19indexmatrixnoNA)],n_clones = 100,folder = paste("ZH19 top 100"), cexset = .3)
...
BCLH(data = zj38alldata[,as.vector(zj38indexmatrixnoNA)], names = zj38allnames[as.vector(zj38indexmatrixnoNA)],n_clones = 100,folder = paste("ZJ38 top 100"), cexset = .3)
