...
#read in data
nonMatrixHeatData <- read.delim("ZH33_HeatmapData_Top100Clones.txt")
...
Gr_xAxisNames <- read.delim("ZH33_Gr_GraphNames.txt", header = F)
...
write.table(combined_df,"Gr_matrix_ZH33_Top100.txt",sep="\t",row.names=FALSE)

rightOrder <- c("6.5m vs.12m","12m vs.21m","21m vs.28m","28m vs.38m","38m vs.43m",
                "43m vs.53m","53m vs.67m","67m vs.79m","79m vs.88.5m","88.5m vs.118m")
