...
#read in data
nonMatrixHeatData <- read.delim("ZH33_HeatmapData_Top10Clones.txt")
...
write.table(combined_df,"Gr_matrix_ZH33_Top10.txt",sep="\t",row.names=FALSE)
