...
#read in data
nonMatrixHeatData <- read.delim("ZJ38_HeatmapData_Top10Clones.txt")
...
write.table(combined_df,"Gr_matrix_ZJ38_Top10.txt",sep="\t",row.names=FALSE)
