...
#read in data
nonMatrixHeatData <- read.delim("ZH19_HeatmapData_Top100Clones.txt")
...
Gr_xAxisNames <- read.delim("ZH19_Gr_GraphNames.txt", header = F)
...
write.table(combined_df,"Gr_matrix_ZH19_Top100.txt",sep="\t",row.names=FALSE)

rightOrder <- c("7m vs.10m","10m vs.22m","22m vs.28m","28m vs.36m","36m vs.44.5m",
                "44.5m vs.52.5m","52.5m vs.62.5m","62.5m vs.78m","78m vs.108m","108m vs.131m")
