...
#read in data
nonMatrixHeatData <- read.delim("ZJ31_HeatmapData_Top10Clones.txt")
...
write.table(combined_df,"Gr_matrix_ZJ31_Top10.txt",sep="\t",row.names=FALSE)
