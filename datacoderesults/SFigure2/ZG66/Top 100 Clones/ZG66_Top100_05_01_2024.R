...
#read in data
nonMatrixHeatData <- read.delim("ZG66_HeatmapData_Top100Clones.txt")
...
Gr_xAxisNames <- read.delim("ZG66_Gr_GraphNames.txt", header = F)
...
write.table(combined_df,"Gr_matrix_ZG66_Top100.txt",sep="\t",row.names=FALSE)

rightOrder <- c("6.5m vs.12m","12m vs.22m","22m vs.27m","27m vs.36m",
                "36m vs.47m","47m vs.50.5m","50.5m vs.55.5m","55.5m vs.67.5m",
                "67.5m vs.82.5m","82.5m vs.106m","106m vs.112m")
