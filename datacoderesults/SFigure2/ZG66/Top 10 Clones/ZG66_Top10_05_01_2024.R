...
#read in data
nonMatrixHeatData <- read.delim("ZG66_HeatmapData_Top10Clones.txt")
...
write.table(combined_df,"Gr_matrix_ZG66_Top10.txt",sep="\t",row.names=FALSE)
