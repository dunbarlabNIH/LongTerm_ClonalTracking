...
zh19keyfile = read.delim("ZH19_key_062024.txt")
...
zh19indexmatrix = matrix(nrow = length(zh19timepoints), ncol = 4, data = c(36:44,NA,45:47,
                                                                           1:9,NA,10:12,
                                                                           24:32,NA,33:35,
                                                                           13:22,NA,NA,23))
zh19indexmatrixnoMono = matrix(nrow = length(zh19timepoints), ncol = 3, data = c(36:44,NA,45:47,
                                                                                 1:9,NA,10:12,
                                                                                 13:22,NA,NA,23))
...
zh19indexmatrixnoNAnoMono = zh19indexmatrixnoMono
zh19indexmatrixnoNAnoMono[is.na(zh19indexmatrixnoMono)] = nrow(zh19keyfile) + 1
